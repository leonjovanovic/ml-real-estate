...
(SELECT COUNT(*) FROM ml_real_estate.real_estates WHERE tip_nekretnine=0) AS 'Stanovi'
/*(SELECT  COUNT(*) FROM ml_real_estate.real_estates WHERE uknjizenost IS NULL AND tip_nekretnine=1) AS 'None kuce'*/ 